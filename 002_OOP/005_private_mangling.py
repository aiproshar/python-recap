...
print("Printing arafat's social security number:", arafat.social_security_number) # Security issue
...
try:
	print("Tyring to print secured arafat's social number")
	print(f"{secured_arafat.__social_security_number}") # Runtime Error: AttributeError: 'PersonImproved' object has no attribute '__social_security_number'
...
so our secured_arafat.__social_security_number becomes secured_arafat._PersonImproved.__social_security_number
...
print("Escaping name mangling, printing arafat's social number:",secured_arafat._PersonImproved__social_security_number)
