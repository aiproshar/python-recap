...
class Person:
    def __init__(self, name, age):
        ...
        self.set_age(
            age
        )  # If you define a setter, the constructor should go through it too — otherwise validation is bypassed on construction
...
But you need to write all the setter logic inside __init__ and it will only run once
